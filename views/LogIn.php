...
<section class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md  dark:bg-gray-900 ">
    <div class="py-8 lg:py-16 px-4  w-[50%] bg-white border rounded-3xl dark: dark:bg-gray-700 m-80  ">
      ...
      <form action="#" class="space-y-8 flex flex-col justify-evenly" id="form">
        ...
        <div class="flex justify-center ">
          <div> <button type="submit"
              class="py-3 px-5 text-sm font-medium text-center text-gray-500 rounded-3xl bg-orange-600 w-60 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800   ">login</button>
          </div>
