...
<div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    ...
    <!--End TABLE USERS-->
              ...
              <!--Categories-->
  <section class=" flex dark:bg-gray-900 p-3 sm:p-5 antialiased">
        <h1 class="text-2xl font-bold text-center mb-6 text-gray-900 dark:text-white">
       Categories
        </h1>
...
<div id="authentication-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="#">
                    <div>
                        ...
                        <input type="text" name="categorie"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" >
                    </div>
  ...
  <!--End Categories-->
        ...
        <h1 class="text-2xl font-bold text-center mb-6 text-gray-900 dark:text-white">
         Tags
        </h1>        <div class="   mx-auto max-w-screen-xl px-4 lg:px-12">
            <!-- -->
            <div class=" dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex justify-end items-center w-full md:w-full">
                    <!-- Div avec le bouton aligné à droite -->
